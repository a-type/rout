/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=GameRegistryBindings -c wrangler.jsonc src/worker-types.d.ts` (hash: 02d18b02a338c7988701f3a5cede721b)
// Runtime types generated with workerd@1.20260410.1 2026-04-12 
declare namespace Cloudflare {
	...
	interface Env {
		DEV_MODE: string;
		"game--number-guess--v1": Fetcher /* game--number-guess--v1 */;
	}
}
interface GameRegistryBindings extends Cloudflare.Env {}
