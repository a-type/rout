/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=ApiBindings --c wrangler.jsonc src/worker-types.d.ts` (hash: 614e015701331e7ea16b89e9bd1df4cf)
// Runtime types generated with workerd@1.20260410.1 2025-01-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "GameSession" | "NotificationScheduler";
	}
	interface Env {
		...
		NOTIFICATION_SCHEDULER: DurableObjectNamespace<import("./index").NotificationScheduler>;
		PUBLIC_STORE: Service<typeof import("./index").PublicStore>;
		ADMIN_STORE: Service<typeof import("./index").AdminStore>;
		GAME_REGISTRY: Fetcher /* prod-long-game-game-registry-service */;
	}
}
