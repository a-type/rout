/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=ApiBindings --c wrangler.jsonc src/worker-types.d.ts` (hash: db8275d030e20a7c9df44a77399eade0)
...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    NOTIFICATION_SCHEDULER: DurableObjectNamespace<
      import('./index').NotificationScheduler
    >;
