/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=BootstrapBindings --c wrangler.toml src/worker-types.d.ts` (hash: 2b1faaebec2b3a9ec338985a09efe17c)
// Runtime types generated with workerd@1.20260120.0 2025-01-01 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
	}
	interface Env {
		ADMIN_STORE: Service /* entrypoint AdminStore from prod-long-game-public-api-service */;
	}
}
interface BootstrapBindings extends Cloudflare.Env {}
